  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      <main className="max-w-4xl mx-auto px-6 py-10">
        ...
        {/* Form Card */}
        <form onSubmit={handleSubmit(onSubmit)} className="bg-white/5 border border-white/10 rounded-2xl p-4 sm:p-8 space-y-6 sm:space-y-8 backdrop-blur-sm">
          
          {/* Section 1: Project & Date */}
          <div className="space-y-4">
            <h2 className="text-base sm:text-lg font-semibold text-white border-b border-white/10 pb-2 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div>
                ...
                {loadingProjects ? (
                  <div className="h-12 bg-slate-800 animate-pulse rounded-lg border border-white/10" />
                ) : (
                  <select
                    id="project-select"
                    {...register('projectId')}
                    className="w-full bg-slate-800/90 border border-white/15 rounded-lg px-3.5 py-3 text-white text-base sm:text-sm min-h-[48px] focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors"
                  >
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                {...register('workDone')}
                className="w-full bg-slate-800/90 border border-white/15 rounded-lg px-3.5 py-3 text-white text-base sm:text-sm placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors resize-y"
              />
              {errors.workDone && (
            ...
            <div>
              ...
              <input
                ...
                {...register('quantity')}
                className="w-full bg-slate-800/90 border border-white/15 rounded-lg px-3.5 py-3 text-white text-base sm:text-sm min-h-[48px] placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-colors"
              />
              {errors.quantity && (
          ...
          <div className="space-y-4">
            ...
            {/* Upload Area */}
            <div className="relative border-2 border-dashed border-white/15 hover:border-indigo-500/50 transition-colors rounded-xl p-5 sm:p-6 text-center bg-slate-800/40">
              <input
              ...
              <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 pt-2">
                {photoPreviews.map((url, idx) => (
                  <div key={idx} className="relative group rounded-xl overflow-hidden border border-white/10 bg-slate-800 aspect-square">
                    ...
                    />
                    {/* Delete button — always touch-accessible on mobile */}
                    <button
                      type="button"
                      onClick={() => handleRemovePhoto(idx)}
                      className="absolute top-1.5 right-1.5 w-8 h-8 rounded-full bg-red-600/90 hover:bg-red-500 text-white flex items-center justify-center shadow-lg transition-transform active:scale-95 z-20"
                      title="Remove photo"
          ...
          {/* Submit Action */}
          <div className="pt-4 border-t border-white/10 flex flex-col-reverse sm:flex-row items-center justify-end gap-3 sm:gap-4">
            <Link
              to="/reports"
              className="w-full sm:w-auto px-5 py-3 text-center text-sm font-medium text-slate-400 hover:text-white transition-colors border border-white/10 rounded-xl sm:border-none"
            >
              Cancel
            </Link>
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 bg-indigo-600 hover:bg-indigo-500 disabled:bg-indigo-600/50 text-white font-semibold text-base sm:text-sm min-h-[48px] rounded-xl transition-colors shadow-lg shadow-indigo-500/25 disabled:cursor-not-allowed"
            >
              {isSubmitting ? (
                <>
